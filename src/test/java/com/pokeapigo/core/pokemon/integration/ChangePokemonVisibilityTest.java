...
import static com.pokeapigo.core.pokemon.util.PokemonTestConstants.NON_EXISTENT_POKEMON_UUID_STRING;
    ...
    class UnhappyPaths {
        ...
        void changePokemonVisibility_whenPokemonNotFound_shouldThrowPokemonNotFoundException(String changeVisibilityJson) {
            given()
                    ...
                    .when()
                    .patch(API_URI_V1 + API_POKEMONS + "/{$pokemonId}/visibility", NON_EXISTENT_POKEMON_UUID_STRING)
